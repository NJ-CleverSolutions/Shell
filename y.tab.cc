...
{
       0,    38,    38,    40,    41,    44,    50,    51,    54,    55,
      58,    59,    62,    68,    71,    80,    91,   104,   112,   122,
     130,   136,   145,   146,   150
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "GREATERTHAN", "PIPE",
  "LESSTHAN", "TWOGREATERTHAN", "GREATERAND", "GREATGREATERTHAN",
  "GREATGREATERAND", "AND", "NOTOKEN", "NEWLINE", "EXIT", "$accept",
  "goal", "commandList", "commandLine", "pipeList", "ioModifierList",
  "backEndOption", "ioModifier", "commandArguments", "commandWord",
  "argumentList", "argumentWord", YY_NULLPTR
};
#endif
...
{
       1,    -8,    -9,    -9,     6,     0,    -9,     2,    -9,    -9,
      -9,    -9,    -9,     5,    11,     7,    -9,     8,     9,    13,
      20,    21,    22,    -9,    -4,    -9,    -9,    -9,    -9,    -9,
      -9,    -9,    -9,    -9,    -9
};
...
{
       0,     0,    21,     6,     0,     0,     3,    11,     8,    23,
       7,     1,     4,     0,    13,    20,     9,     0,     0,     0,
       0,     0,     0,    12,     0,    10,    24,    22,    16,    19,
      17,    18,    14,    15,     5
};
...
{
      -2,     1,     1,     2,     2,    10,    11,    13,     2,    34,
      26,    28,    29,     3,     3,    17,    30,    18,    19,    20,
      21,    22,    23,    31,    32,    33,     0,    16,    12
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     3,     3,    13,     0,     5,     3,    13,
       3,     3,     3,    13,    13,     4,     3,     6,     7,     8,
       9,    10,    11,     3,     3,     3,    -1,    13,     5
};
...
{
       0,     1,     3,    13,    16,    17,    18,    19,    23,    24,
      13,     0,    18,     5,    20,    25,    23,     4,     6,     7,
       8,     9,    10,    11,    21,    22,     3,    26,     3,     3,
       3,     3,     3,     3,    13
};
...
#line 71 "shell.y"
                ...
                Shell::currentCommand.outFile = (yyvsp[0].cpp_string);
                Shell::currentCommand.append = (yyvsp[0].cpp_string);
        }
#line 1406 "y.tab.cc"
    break;
...
#line 80 "shell.y"
                ...
                Shell::currentCommand.outFile = (yyvsp[0].cpp_string);
                Shell::currentCommand.errFile = (yyvsp[0].cpp_string);
...
#line 122 "shell.y"
                ...
                Shell::currentCommand.inFile = (yyvsp[0].cpp_string);
        }
#line 1471 "y.tab.cc"
    break;
...
#line 136 "shell.y"
             {
                ...
                Command::currentSimpleCommand->insertArgument( (yyvsp[0].cpp_string) );
        }
#line 1492 "y.tab.cc"
    break;
...
#line 150 "shell.y"
             {
                ...
                char * tester = (char*)(yyvsp[0].cpp_string)->c_str();
                if(strchr(tester,'*') == NULL) {
                        Command::currentSimpleCommand->insertArgument((yyvsp[0].cpp_string));
                }else{
                        char * prefix = (char*)"";
                        wildCards(prefix, (char*)(yyvsp[0].cpp_string)->c_str());
